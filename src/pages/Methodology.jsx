...
export default function Methodology() {
  ...
  return (
    <div style={{ padding: '0 24px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'var(--font-body)' }}>
      <Helmet>
        ...
        <style>{`
          .meth-layout { display: flex; gap: 64px; margin-top: 48px; margin-bottom: 80px; flex-direction: row; }
          .meth-main { flex: 1; min-width: 0; max-width: 800px; }
          .meth-toc-wrapper { width: 220px; flex-shrink: 0; }
          .meth-toc { position: sticky; top: 80px; display: flex; flex-direction: column; gap: 12px; }
          .meth-toc-link { font-family: 'IBM Plex Mono', ui-monospace, monospace; font-size: 12px; color: var(--text-muted); text-decoration: none; padding-left: 8px; border-left: 2px solid transparent; transition: border-color 0.2s, color 0.2s; cursor: pointer; background: none; border: none; border-left: 2px solid transparent; text-align: left; padding: 4px 0 4px 8px; }
          .meth-toc-link:hover { border-left-color: #E67E22; color: var(--text-primary); }
          ...
          @media (max-width: 768px) {
            .meth-layout { flex-direction: column; gap: 32px; margin-top: 24px; }
            .meth-toc-wrapper { width: 100%; margin-bottom: 24px; border-bottom: 1px solid var(--border); padding-bottom: 12px; }
            .meth-toc { position: static; flex-direction: row; overflow-x: auto; white-space: nowrap; padding-bottom: 8px; gap: 24px; }
            .meth-toc-link { padding: 0 0 8px 0; border-left: none; border-bottom: 2px solid transparent; }
            .meth-toc-link:hover { border-bottom-color: #E67E22; border-left-color: transparent; }
      ...
      <div className="meth-layout">
        ...
        <div className="meth-main">
          ...
          <div style={{ marginBottom: '64px' }}>
            ...
            <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: '15px', lineHeight: 1.6, color: 'var(--text-secondary)', margin: '0 0 24px 0', maxWidth: '640px' }}>
          ...
          <div id="section-01" style={styles.section}>
          ...
          <div id="section-02" style={styles.section}>
            ...
            <h2 style={styles.h2}>The Six Signals</h2>
            <p style={styles.prose}>
            ...
            <div dangerouslySetInnerHTML={{ __html: SIGNAL_COMPONENT_HTML }} />
          ...
          <div id="section-03" style={styles.section}>
            ...
            <h2 style={styles.h2}>The Three Tiers</h2>
            
            <div dangerouslySetInnerHTML={{ __html: DISTRIBUTION_COMPONENT_HTML }} />
          </div>

          {/* 04 — Monitoring Spirit Signals */}
          <div id="section-04" style={styles.section}>
            <p style={styles.eyebrow}>04 / monitoring spirit</p>
            <h2 style={styles.h2}>Monitoring Spirit Signals</h2>
          ...
          <div id="section-05" style={styles.section}>
            ...
            <h2 style={styles.h2}>Special Cases</h2>
        ...
        <div className="meth-toc-wrapper">
          <div className="meth-toc">
            <p style={{ fontFamily: "'IBM Plex Mono', ui-monospace, monospace", fontSize: '10px', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'var(--text-muted)', margin: '0 0 8px 0' }}>
              CONTENTS
            </p>
            <button onClick={() => scrollTo('section-01')} className="meth-toc-link">01 / what the tii measures</button>
            <button onClick={() => scrollTo('section-02')} className="meth-toc-link">02 / the six signals</button>
            <button onClick={() => scrollTo('section-03')} className="meth-toc-link">03 / the three tiers</button>
            <button onClick={() => scrollTo('section-04')} className="meth-toc-link">04 / monitoring spirit</button>
            <button onClick={() => scrollTo('section-05')} className="meth-toc-link">05 / special cases</button>
            <button onClick={() => scrollTo('section-06')} className="meth-toc-link">06 / what we do not claim</button>
            <button onClick={() => scrollTo('section-07')} className="meth-toc-link">07 / data sources</button>
            <button onClick={() => scrollTo('section-08')} className="meth-toc-link">08 / contact</button>
          </div>
        </div>
      </div>
    </div>
