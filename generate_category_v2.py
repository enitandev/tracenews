...
export default function Category() {
  ...
  const pct = Math.round(bias_breakdown[dominant]/total*100);
  ...
  const synthCoverageStats = {
    coverage_tier_distribution: {
      pro_establishment: bias_breakdown.pro_establishment,
      institutional: bias_breakdown.institutional,
      adversarial: bias_breakdown.adversarial
    },
    total_coverage: bias_breakdown.total
  };
  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '32px 24px', fontFamily: 'var(--font-body)' }}>
      ...
      <div className="mobile-stack mobile-stack-divider" style={{ display: 'flex', gap: '48px', alignItems: 'flex-start' }}>
        ...
        <div style={{ width: '28%', flexShrink: 0, display: 'flex', flexDirection: 'column', gap: '16px' }}>
          
          {/* CARD 1: Covered Most By */}
          <div style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: '8px', padding: '16px' }}>
            <h3 style={{ fontSize: '14px', fontWeight: 700, margin: '0 0 16px 0', color: 'var(--text-primary)' }}>Covered Most By</h3>
              ...
              {covered_most_by.map((outlet, idx) => {
                ...
                return (
                  <div key={idx} style={{ 
                    ...
                    <span style={{ fontSize: '13px', fontWeight: 600, color: 'var(--text-primary)', flex: 1 }}>{outlet.name}</span>
                    <span style={{ 
          ...
          <div style={{ background: 'rgba(180,160,130,0.10)', border: '1px solid rgba(180,160,130,0.25)', borderRadius: '8px', padding: '16px' }}>
            <h3 style={{ fontSize: '14px', fontWeight: 700, margin: '0 0 8px 0', color: 'var(--text-primary)' }}>Suggest a Source</h3>
          ...
          <div style={{ background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: '8px', padding: '16px' }}>
            <h3 style={{ fontSize: '14px', fontWeight: 700, margin: '0 0 4px 0', color: 'var(--text-primary)' }}>Coverage Breakdown</h3>
